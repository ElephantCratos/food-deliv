...
echo ""
echo "--------------------------------"
echo "Flashphoner License Deactivation"
echo "--------------------------------"
echo ""
java $WCS_PROXY_OPTS -Djavax.net.ssl.trustStore=$WCS_APP_HOME/conf/myflashphoner-ca -Dcom.flashphoner.fms.AppHome="$WCS_APP_HOME" -cp "$WCS_APP_HOME/lib/*" com.flashphoner.server.license.Deactivation
echo ""
