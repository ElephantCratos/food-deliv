...
class UserManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user-management.index')->with('success', 'Пользователь создан');
    }
    ...
    public function destroy(User $user)
    {
        ...
        return redirect()->route('user-management.index')->with('success', 'Пользователь удалён');
    }
}
