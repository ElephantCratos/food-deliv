@extends('layouts.baseLayout') <!-- с этим надо чёто сделать ибо нахуя в админ панеле там хедер который идёт для юзеров -->
...
@section('content')
    <!-- Вставляем новый хедер -->
    @include('layouts.navigation')  <!-- второй хедер -->
