...
<x-app-layout>
    <div class="py-12 flex justify-center items-center" style="margin: 50px;">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 w-full">
            <div class="bg-white dark:bg-white-800 overflow-hidden shadow-sm sm:rounded-lg p-5 w-full">

                <!-- Заголовок страницы -->
                <h1 class="text-2xl font-semibold text-dark-900 dark:text-dark mb-6">Список пользователей</h1>
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="w-1/2">
                        <input
                          ...
                          class="px-4 py-2 border border-dark-300 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                          onkeyup="filterUsers()"
                        />
                    </div>
                    <!-- Фильтр по ролям -->
